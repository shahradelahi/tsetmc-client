...
export default async function getInstrumentInfo(params: GetInstrumentInfoParams): Promise<SafeReturn<InstrumentInfo>> {
   try {
      const {
         data: response,
         error
      } = await request(`http://cdn.tsetmc.com/api/Instrument/GetInstrumentInfo/${params.insId}`)
