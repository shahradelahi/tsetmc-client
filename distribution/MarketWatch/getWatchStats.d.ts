...
export declare enum STATS_POSITIVE_DAYS_INDICES {
    days_count_3_month = 26,
    days_count_12_month = 27,
    days_percent_3_month = 28,
    days_percent_12_month = 29,
    days_rank_3_month = 30,
    days_rank_12_month = 31
}
...
export declare enum STATS_OPEN_DAYS_INDICES {
...
export declare function getWatchStatsRaw(options?: RequestOptions): Promise<SafeReturn<any>>;
export default function getWatchStats(options?: RequestOptions): Promise<SafeReturn<WatchStatsData>>;
export {};
