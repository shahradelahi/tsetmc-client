...
function getTradersType(params, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var insId, dEven, _a, response, error, data, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    insId = params.insId, dEven = params.dEven;
                    return [4 /*yield*/, (0, request_1.request)("http://cdn.tsetmc.com/api/ClientType/GetClientTypeHistory/".concat(insId, "/").concat(dEven), options)];
                case 1:
...
exports.default = getTradersType;
//# sourceMappingURL=getTradersType.js.map