...
function getThresholds(params, options) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, request_1.request)("http://cdn.tsetmc.com/api/MarketData/GetStaticThreshold/".concat(insId, "/").concat(dEven), options)];
                case 1:
